...
MergeFileDialog::MergeFileDialog(wxWindow* parent,wxWindowID id,const wxPoint& pos,const wxSize& size)
{
	...
	BoxSizer4->Add(StaticBoxSizer3, 3, wxALL|wxEXPAND, 5);
	...
	BoxSizer4->Add(BoxSizer3, 0, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	BoxSizer1->Add(BoxSizer4, 1, wxALL|wxEXPAND, 10);
...
{
    wxMessageDialog dlg(this, _("Are you sure to continue?"), _("Before Deleting"), wxYES_NO|wxCENTER|wxICON_INFORMATION);
